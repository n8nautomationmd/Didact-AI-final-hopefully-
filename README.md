...
Datasetul furnizat este **utilizabil pentru o demonstrație competitivă**, dar nu este încă suficient pentru producție. Setul brut are 489 exerciții (477 cu temă + dificultate, 51 duplicate exacte, 12 rânduri fără etichete), iar pentru antrenare îl augmentăm la **1344 rânduri**. Este aliniat la matematica de examen și conține exact câmpurile necesare pentru cele două servicii ML: textul problemei, tema și dificultatea. Pentru versiunea următoare, cel mai bun dataset ar fi o colecție extinsă din arhive oficiale + etichetare profesorală pentru competențe și erori conceptuale.
...
docs/competition_QA.md              # răspunsuri la întrebări care pot apărea
``` 
...
- **Nivel specific:** acoperă gimnaziu de bază; un model antrenat aici nu generalizează la matematică de nivel superior.
...
**Transparență.** Metricile sunt calculate, nu fabricate, și pot fi regenerate de oricine cu `python -m src.train_models`.
